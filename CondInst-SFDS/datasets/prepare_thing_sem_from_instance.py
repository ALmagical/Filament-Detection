...
register_coco_instances(
    "coco_filament_train", {}, 
    "/home/gxl/Data/20210529/annotations/train.json", 
    "/home/gxl/Data/20210529/train")
register_coco_instances(
    "coco_filament_val", {},
...
def _process_instance_to_semantic(anns, output_semantic, img, categories):
    ...
    for ann in anns:
        ...
        # @gxl use categories[ann["category_id"]] will get error
        output[mask == 1] = ann["category_id"] + 1
