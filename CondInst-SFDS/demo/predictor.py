...
from gxl.units.visualizer import VisualizerArea, VisualizerNoneLabel
from adet.utils.visualizer import TextVisualizer


class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False, vis_area=False, non_label=False):
        """
        Args:
            cfg (CfgNode):
    ...
    def run_on_image(self, image):
        ...
        # @gxl
            ...
            visualizer = VisualizerArea(image, self.metadata, instance_mode=self.instance_mode)
        elif self.non_label:
            visualizer = VisualizerNoneLabel(image, self.metadata, instance_mode=self.instance_mode)
        else:
