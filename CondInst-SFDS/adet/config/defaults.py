...
# @ gxl
# Resnet-d
_C.MODEL.RESNETD = False
_C.MODEL.RESNETD_SE = False
_C.MODEL.RESNETD_PPSA = False

_C.MODEL.BACKBONE.ACTIVATION = 'ReLU'

_C.MODEL.FPN.ATTENTION = None
# ---------------------------------------------------------------------------- #
# FCOS Head
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
...
_C.MODEL.FCOS.REG_WEIGHT = 2.0
_C.MODEL.FCOS.NORM_REG_TARGETS = True
_C.MODEL.FCOS.NMS_TYPE = 'normal'

# @GXL

# For Attention
_C.MODEL.FCOS.USE_ATTENTION = False
_C.MODEL.FCOS.ATTENTION_MODEL = 'PSA'
...
_C.MODEL.CONDINST.MASK_HEAD.SPECIAL_CLASSES_LOSS = False
_C.MODEL.CONDINST.MASK_HEAD.SPECIAL_CLASSES = []
_C.MODEL.CONDINST.MASK_HEAD.ALPHA = 0.2
_C.MODEL.CONDINST.MASK_HEAD.BETA = 0.8
_C.MODEL.CONDINST.MASK_HEAD.ACTIVATION = 'ReLU'

# @gxl
# For special thresh
_C.MODEL.CONDINST.MASK_HEAD.SPECIAL_CLASSES_THRESH = False
_C.MODEL.CONDINST.MASK_HEAD.NMS_THRESH_NORM = 0.6
_C.MODEL.CONDINST.MASK_HEAD.NMS_THRESH_SPC = 0.3
_C.MODEL.CONDINST.MASK_HEAD.NMS_THRESH_ALL = 0.8

_C.MODEL.CONDINST.MASK_HEAD.USE_MASK_NMS = False
_C.MODEL.CONDINST.MASK_HEAD.NMS_PRE = 500
_C.MODEL.CONDINST.MASK_HEAD.SCORE_THR = 0.1
_C.MODEL.CONDINST.MASK_HEAD.UPDATE_THR = 0.05
_C.MODEL.CONDINST.MASK_HEAD.MASK_THR = 0.5
_C.MODEL.CONDINST.MASK_HEAD.MAX_PRE_IMG = 100
# Matrix NMS kernel type: gaussian OR linear.
_C.MODEL.CONDINST.MASK_HEAD.NMS_KERNEL = "gaussian"
_C.MODEL.CONDINST.MASK_HEAD.NMS_SIGMA = 2
_C.MODEL.CONDINST.MASK_HEAD.FUSE_MASK = False

# @gxl
_C.MODEL.CONDINST.USE_CENTROID = False
_C.MODEL.CONDINST.TOP_WITH_COORDS = False
_C.MODEL.CONDINST.BOX_WITH_COORDS = False
_C.MODEL.CONDINST.CLS_WITH_COORDS = False
...
_C.MODEL.CONDINST.MASK_BRANCH.USE_ATTENTION = False
_C.MODEL.CONDINST.MASK_BRANCH.ATTENTION_MODEL = 'DA'
_C.MODEL.CONDINST.MASK_BRANCH.FUSE_TYPE = 'sum'
_C.MODEL.CONDINST.MASK_BRANCH.ACTIVATION = 'ReLU'
_C.MODEL.CONDINST.MASK_BRANCH.ASPP = False
_C.MODEL.CONDINST.MASK_BRANCH.DECODER = False

_C.MODEL.CONDINST.ASPP = False
# @gxl
# POTO options
_C.MODEL.POTO = CN()

_C.MODEL.POTO.ALPHA = 0.8
_C.MODEL.POTO.CENTER_SAMPLING_RADIUS = 1.5
_C.MODEL.POTO.AUX_TOPK = 9
_C.MODEL.POTO.FILTER_KERNEL_SIZE = 3
_C.MODEL.POTO.FILTER_TAU = 2

# @GXL POTO
# SHIFTER GENERATOR
_C.MODEL.SHIFT_GENERATOR = CN()
_C.MODEL.SHIFT_GENERATOR.NUM_SHIFTS = 1
_C.MODEL.SHIFT_GENERATOR.OFFSET = 0.5
