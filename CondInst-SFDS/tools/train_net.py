...
from gxl.data.my_evaluator import Evaluator_GXL
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        """
        mapper = DatasetMapper_GXL(cfg, True)
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["coco", "coco_panoptic_seg"]:
            ...
            #evaluator_list.append(Evaluator_GXL(dataset_name, cfg, True, output_folder,ignore_label=[],use_fast_impl=False))
...
def main(args):
    ...
    if args.eval_only:
        ...
        #torch.save(dill.dumps(model), cfg.OUTPUT_DIR+'model.pth')
        return res
