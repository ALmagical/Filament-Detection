...
register_coco_instances(
    "coco_filament_train", {"thing_classes": ["Filament", "Filaments", "Filament_alone"],
    "thing_colors":[[216, 27, 96], [124, 179, 66], [3, 155, 229]]}, 
    "/home/gxl/Data/20210405/annotations/train.json", 
    "/home/gxl/Data/20210405/train")
register_coco_instances(
    "coco_filament_val", {"thing_classes": ["Filament", "Filaments", "Filament_alone"],
    "thing_colors":[[216, 27, 96], [124, 179, 66], [3, 155, 229]]},  
...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="output/20210408/config.yaml",
        metavar="FILE",
